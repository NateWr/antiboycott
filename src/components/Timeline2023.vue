    ...
    <div class="timeline-text-group">
      <TimelineText :keyframe="keyframe" :start="KEY_2023_START" :end="KEY_2023_COLLAPSE">
        <span class="fade" :class="keyframe >= KEY_2023_TARGETS_EXPAND ? 'fade-in' : 'fade-out'">
          ...
          a model bill drafted by the American Legislative Exchange Council (ALEC), a right-wing corporate lobbying group, to <strong>expand the legislative assault</strong> on trans rights, abortion access, and labor rights.
        </span>
      </TimelineText>
    </div>
