...
const laws = computed(() => {
  return props.allLaws.filter(law => law.year === 2019)
})

const currentLaws = computed(() => {
  if (props.fired.find(t => t.id === KEY_2019_START)) {
...
<template>
  <div class="timeline-year">
    ...
    <TimelineDate :keyframe="keyframe" :target="KEY_2019_START">
      2019
    </TimelineDate>
